...
exports.freezeTokensBuilder = exports.freezeTokensOperationHandler = exports.freezeTokensOperation = void 0;
 ...
 */
exports.freezeTokensOperation = (0, types_1.useOperation)(Key);
/**
 * @group Operations
 * @category Handlers
 */
exports.freezeTokensOperationHandler = {
    handle(operation, metaplex) {
        return __awaiter(this, void 0, void 0, function* () {
            return (0, exports.freezeTokensBuilder)(metaplex, operation.input).sendAndConfirm(metaplex, operation.input.confirmOptions);
        });
    },
};
/**
...
const freezeTokensBuilder = (metaplex, params) => {
    ...
    return utils_1.TransactionBuilder.make().add({
        instruction: (0, spl_token_1.createFreezeAccountInstruction)(tokenAddressOrAta, mintAddress, authorityPublicKey, multiSigners, tokenProgram),
        signers,
        key: (_a = params.instructionKey) !== null && _a !== void 0 ? _a : 'freezeTokens',
    });
};
exports.freezeTokensBuilder = freezeTokensBuilder;
//# sourceMappingURL=freezeTokens.js.map