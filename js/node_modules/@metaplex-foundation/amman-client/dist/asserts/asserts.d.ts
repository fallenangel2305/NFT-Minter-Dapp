 ...
 * @category asserts
 */
export declare function assertError(t: Assert, err: Error, msgRxs: RegExp[]): void;
/**
 ...
 * @private
 */
export declare function assertContainMessages(t: Assert, logs: string[], msgRxs: RegExp[], label?: string): void;
/**
 ...
 */
export declare function assertErrorMatches<Err extends Function>(t: Assert, err: MaybeErrorWithCode, opts?: {
    type?: Err;
    msgRx?: RegExp;
    txSignature?: string;
}): void;
