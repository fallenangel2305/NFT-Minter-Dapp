...
class ConfirmedTransactionAssertablePromise extends Promise {
    constructor(executor, requireAssert) {
        var _a;
        super(executor);
...
${this.errorStack}`);
    ...
    async assertSuccess(t, msgRxs) {
        ...
        (0, asserts_1.assertTransactionSuccess)(t, details, msgRxs);
        return details;
    }
    /**
    ...
    async assertError(t, errOrRx, msgRx) {
        this.calledAssert = true;
        const details = await this;
        (0, asserts_1.assertTransactionError)(t, details, errOrRx, msgRx);
        return details;
    }
    /**
    ...
    async assertThrows(t, errOrRx, msgRx) {
        ...
        try {
            const details = await this;
            t.fail('expected to throw an error when sending/confirming the transaction');
            return details;
        }
        catch (err) {
    ...
    async assertLogs(t, msgRxs) {
        this.calledAssert = true;
        const details = await this;
        (0, asserts_1.assertContainMessages)(t, details.txSummary.logMessages, msgRxs, 'log messages');
    }
    /**
