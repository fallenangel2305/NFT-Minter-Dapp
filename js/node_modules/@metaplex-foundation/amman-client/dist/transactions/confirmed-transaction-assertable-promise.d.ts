...
export declare class ConfirmedTransactionAssertablePromise extends Promise<ConfirmedTransactionDetails> implements ConfirmedTransactionAsserts {
    ...
    private errorStack?;
    constructor(executor: (resolve: (value: ConfirmedTransactionDetails | PromiseLike<ConfirmedTransactionDetails>) => void, reject: (reason?: any) => void) => void, requireAssert: boolean);
    /**
     ...
     * @category asserts
     */
    assertSuccess(t: Assert, msgRxs?: RegExp[]): Promise<ConfirmedTransactionDetails>;
    /**
     ...
     * @category asserts
     */
    assertError<Err extends Function>(t: Assert, errOrRx?: Err | RegExp, msgRx?: RegExp): Promise<ConfirmedTransactionDetails>;
    /**
     ...
     * @category asserts
     */
    assertThrows<Err extends Function>(t: Assert, errOrRx?: Err | RegExp, msgRx?: RegExp): Promise<ConfirmedTransactionDetails | undefined>;
    /**
     ...
     * @category asserts
     */
    assertNone(): Promise<ConfirmedTransactionDetails>;
}
