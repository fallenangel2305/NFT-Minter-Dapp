...
exports.ConfirmedTransactionDetails = void 0;
 ...
 */
class ConfirmedTransactionDetails {
    constructor(args) {
    ...
    async assertLogs(t, msgRxs) {
        (0, asserts_1.assertContainMessages)(t, this.txSummary.logMessages, msgRxs, 'log messages');
    }
}
exports.ConfirmedTransactionDetails = ConfirmedTransactionDetails;
