 ...
 *
 */
export declare function restartValidatorWithAccountOverrides(ammanState: AmmanState, addresses: string[], accountLabels: Record<string, string>, keypairs: Map<string, {
    keypair: Keypair;
    id: string;
 ...
 */
export declare function restartValidatorWithSnapshot(ammanState: AmmanState, snapshotLabel: string): Promise<{
    persistedAccountInfos: PersistedAccountInfo[];
    persistedSnapshotAccountInfos: (PersistedAccountInfo & {
        label: string;
        accountPath: string;
