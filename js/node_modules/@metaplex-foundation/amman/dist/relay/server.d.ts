...
declare class RelayServer {
    ...
    constructor(io: Server, ammanState: AmmanState, accountProvider: AccountProvider, accountPersister: AccountPersister, snapshotPersister: AccountPersister, accountStates: AccountStates, allKnownLabels?: Record<string, string>);
