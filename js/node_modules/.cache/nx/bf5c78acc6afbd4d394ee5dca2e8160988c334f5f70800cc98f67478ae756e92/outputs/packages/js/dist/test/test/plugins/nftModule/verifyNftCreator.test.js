...
(0, tape_1.default)('[nftModule] it can verify a creator', (t) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield mx.nfts().verifyCreator({ mintAddress: nft.address, creator }).run();
...
//# sourceMappingURL=verifyNftCreator.test.js.map