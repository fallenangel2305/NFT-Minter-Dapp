...
exports.TokenAndMintDoNotMatchError = exports.MintAuthorityMustBeSignerToMintInitialSupplyError = exports.TokenError = void 0;
const errors_1 = require("../../errors");
/** @group Errors */
class TokenError extends errors_1.MetaplexError {
    constructor(input) {
        super(Object.assign(Object.assign({}, input), { key: `plugin.token.${input.key}`, title: `Token > ${input.title}`, source: 'plugin', sourceDetails: 'Token' }));
    }
}
...
class MintAuthorityMustBeSignerToMintInitialSupplyError extends TokenError {
    constructor(options) {
        super({
            ...
            problem: 'You are trying to create a Mint and a Token account and to send an initial ' +
            ...
            solution: 'Please provide the Mint Authority as a Signer when using the "createTokenWithMint" operation ' +
...
class TokenAndMintDoNotMatchError extends TokenError {
    constructor(token, tokenMint, mint, options) {
        super({
            ...
            problem: `The provided Token and Mint accounts do not match. That is, the mint address [${tokenMint}] ` +
