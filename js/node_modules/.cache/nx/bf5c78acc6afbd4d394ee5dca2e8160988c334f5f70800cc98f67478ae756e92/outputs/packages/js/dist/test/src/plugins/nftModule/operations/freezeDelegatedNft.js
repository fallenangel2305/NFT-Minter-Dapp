...
exports.freezeDelegatedNftBuilder = exports.freezeDelegatedNftOperationHandler = exports.freezeDelegatedNftOperation = void 0;
 ...
 */
exports.freezeDelegatedNftOperation = (0, types_1.useOperation)(Key);
/**
 * @group Operations
 * @category Handlers
 */
exports.freezeDelegatedNftOperationHandler = {
    handle(operation, metaplex) {
        return __awaiter(this, void 0, void 0, function* () {
            return (0, exports.freezeDelegatedNftBuilder)(metaplex, operation.input).sendAndConfirm(metaplex, operation.input.confirmOptions);
        });
    },
};
/**
...
const freezeDelegatedNftBuilder = (metaplex, params) => {
    ...
    return utils_1.TransactionBuilder.make().add({
        instruction: (0, mpl_token_metadata_1.createFreezeDelegatedAccountInstruction)({
        ...
        key: (_a = params.instructionKey) !== null && _a !== void 0 ? _a : 'freezeDelegatedNft',
    });
};
exports.freezeDelegatedNftBuilder = freezeDelegatedNftBuilder;
//# sourceMappingURL=freezeDelegatedNft.js.map